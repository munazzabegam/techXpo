...
<body class="bg-dark text-white">
    <div class="container mt-5">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $duplicateCheckQuery = "SELECT * FROM TechXpo WHERE TeamLeaderEmail = '$teamLeaderEmail'";
